...
```bash
curl -s -b cookie_stockmovements.txt "http://localhost:3001/api/stock-movements?page=1&limit=10"
```
...
```bash
curl -s -b cookie_stockmovements.txt "http://localhost:3001/api/stock-movements?type=IN"
```
...
```bash
curl -s -b cookie_stockmovements.txt "http://localhost:3001/api/stock-movements?type=OUT"
```
...
```bash
curl -s -b cookie_stockmovements.txt "http://localhost:3001/api/stock-movements?type=TRANSFER"
```
...
```bash
curl -s -b cookie_stockmovements.txt "http://localhost:3001/api/stock-movements?inventoryItemId=1"
```
...
```bash
curl -s -b cookie_stockmovements.txt "http://localhost:3001/api/stock-movements?warehouseId=1"
```
...
```bash
curl -s -b cookie_stockmovements.txt "http://localhost:3001/api/stock-movements?startDate=2025-01-01&endDate=2025-12-31"
```
...
```bash
curl -s -b cookie_stockmovements.txt "http://localhost:3001/api/stock-movements?q=صنف"
```
...
```bash
curl -s -b cookie_stockmovements.txt "http://localhost:3001/api/stock-movements?sort=createdAt&sortDir=DESC"
```
...
```bash
curl -s -b cookie_stockmovements.txt "http://localhost:3001/api/stock-movements?type=IN&warehouseId=1&startDate=2025-01-01&q=صيانة&page=1&limit=20&sort=createdAt&sortDir=DESC"
```
...
```bash
curl -s "http://localhost:3001/api/stock-movements"
```
...
```bash
curl -s -b cookie_stockmovements.txt "http://localhost:3001/api/stock-movements/1"
```
...
```bash
curl -s -b cookie_stockmovements.txt "http://localhost:3001/api/stock-movements/99999"
```
...
```bash
curl -s "http://localhost:3001/api/stock-movements/1"
```
...
```bash
curl -s -b cookie_stockmovements.txt "http://localhost:3001/api/stock-movements/inventory/1"
```
...
```bash
curl -s -b cookie_stockmovements.txt "http://localhost:3001/api/stock-movements/inventory/99999"
```
...
```bash
curl -s "http://localhost:3001/api/stock-movements/inventory/1"
```
...
curl -s -X PUT -b cookie_stockmovements.txt -H "Content-Type: application/json" \
  ...
  "http://localhost:3001/api/stock-movements/1"
```
...
curl -s -X PUT -b cookie_stockmovements.txt -H "Content-Type: application/json" \
  -d '{"type":"IN","inventoryItemId":1,"quantity":10,"toWarehouseId":1}' \
  "http://localhost:3001/api/stock-movements/99999"
```
...
```bash
curl -s -X DELETE -b cookie_stockmovements.txt "http://localhost:3001/api/stock-movements/1"
```
...
```bash
curl -s -X DELETE -b cookie_stockmovements.txt "http://localhost:3001/api/stock-movements/99999"
```
...
```bash
curl -s -X DELETE "http://localhost:3001/api/stock-movements/1"
```
...
```bash
curl -s -b cookie_stockmovements.txt "http://localhost:3001/api/stock-movements/stats/summary"
```
...
```bash
curl -s -b cookie_stockmovements.txt "http://localhost:3001/api/stock-movements/stats/summary?type=IN&warehouseId=1&dateFrom=2025-01-01&dateTo=2025-12-31"
```
...
```bash
curl -s "http://localhost:3001/api/stock-movements/stats/summary"
```
