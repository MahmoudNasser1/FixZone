...
**Request:**
```bash
curl -b cookies.txt -X GET "http://localhost:4000/api/reports/daily-revenue"
```
...
**Request:**
```bash
curl -b cookies.txt -X GET "http://localhost:4000/api/reports/monthly-revenue?year=2025&month=11"
```
...
**Request:**
```bash
curl -b cookies.txt -X GET "http://localhost:4000/api/reports/expenses"
```
...
**Request:**
```bash
curl -b cookies.txt -X GET "http://localhost:4000/api/reports/profit-loss"
```
...
**Request:**
```bash
curl -b cookies.txt -X GET "http://localhost:4000/api/reports/technician-performance"
```
...
**Request:**
```bash
curl -b cookies.txt -X GET "http://localhost:4000/api/reports/inventory-value"
```
...
**Request:**
```bash
curl -b cookies.txt -X GET "http://localhost:4000/api/reports/pending-payments"
```
