-- ============================================================================
-- Migration: Create Notes and NoteAttachments tables for technician notes system
-- Date: 2025-01-27
...
-- Step 1: Create Notes table (if not exists)
...
-- Step 2: Create NoteAttachments table (if not exists)
...
-- AND TABLE_NAME IN ('Notes', 'NoteAttachments');
-- 
