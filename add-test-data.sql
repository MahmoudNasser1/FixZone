...
-- إضافة عميل تجريبي إذا لم يكن موجود
...
-- إضافة فاتورة تجريبية إذا لم تكن موجودة
...
-- إضافة فاتورة أخرى مع مدفوعات
INSERT IGNORE INTO Invoice (id, invoiceNumber, customerId, totalAmount, finalAmount, issueDate, dueDate, status, createdBy, createdAt, updatedAt)
VALUES (2, 'INV-002', 1, 2000.00, 2000.00, CURDATE(), DATE_ADD(CURDATE(), INTERVAL 30 DAY), 'draft', 1, NOW(), NOW());

INSERT IGNORE INTO Payment (id, invoiceId, amount, currency, paymentMethod, paymentDate, referenceNumber, notes, createdBy, createdAt, updatedAt)
VALUES 
(4, 2, 1000.00, 'EGP', 'cash', CURDATE(), 'REF-004', 'دفعة تجريبية 4', 1, NOW(), NOW()),
(5, 2, 500.00, 'EGP', 'card', CURDATE(), 'REF-005', 'دفعة تجريبية 5', 1, NOW(), NOW());
