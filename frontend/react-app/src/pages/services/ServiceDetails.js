    ...
    return (
      <div className="p-6 bg-white min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">الخدمة المطلوبة غير موجودة أو تم حذفها</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">تفاصيل الخدمة</h2>
            ...
            <div className="space-y-4">
              ...
              {service.description && (
                <div className="flex items-start space-x-3 space-x-reverse">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">الوصف</h3>
              ...
              <div className="flex items-start space-x-3 space-x-reverse">
                ...
                <div>
                  <h3 className="font-medium text-gray-900">السعر الأساسي</h3>
              ...
              {service.category && (
                <div className="flex items-start space-x-3 space-x-reverse">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">الفئة</h3>
              ...
              {service.estimatedDuration && (
                <div className="flex items-start space-x-3 space-x-reverse">
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900">المدة المقدرة</h3>
              ...
              <div className="flex items-start space-x-3 space-x-reverse">
                ...
                <div>
                  <h3 className="font-medium text-gray-900">الحالة</h3>
          ...
          {/* Usage Statistics */}
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">إحصائيات الاستخدام</h2>
              ...
              <>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-600">المكتمل</div>
                  </div>
                  <div className="text-center">
